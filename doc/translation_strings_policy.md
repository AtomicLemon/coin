...
This document provides guidelines for internationalization of the BFN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `BFN_en.ts` remains unchanged.
