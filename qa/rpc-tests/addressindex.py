...
class AddressIndexTest(BFNTestFramework):
    ...
    def run_test(self):
        ...
        print("Testing querying txids by range of block heigBFN..")
        ...
        # Check that deltas can be returned from range of block heigBFN
