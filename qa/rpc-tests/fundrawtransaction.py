...
class RawTransactionsTest(BFNTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid BFN address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid BFN address" in e.error['message'])
