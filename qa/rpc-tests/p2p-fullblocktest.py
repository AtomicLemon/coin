...
'''
This reimplements tests from the BFNj/FullBlockTestGenerator used
by the pull-tester.
...
class FullBlockTest(ComparisonTestFramework):
    ...
    def next_block(self, number, spend=None, additional_coinbase_value=0, script=CScript([OP_TRUE]), solve=True):
        ...
        height = self.block_heigBFN[base_block_hash] + 1
        ...
        if solve:
            block.solve()
        self.tip = block
        self.block_heigBFN[block.sha256] = height
    ...
    def get_tests(self):
        ...
        self.block_heigBFN[self.genesis_hash] = 0
        spendable_outputs = []
        ...
        def update_block(block_number, new_transactions):
            ...
            if block.sha256 != old_sha256:
                self.block_heigBFN[block.sha256] = self.block_heigBFN[old_sha256]
                del self.block_heigBFN[old_sha256]
        ...
        # Extend the b26 chain to make sure BFNd isn't accepting b26
        ...
        # Extend the b28 chain to make sure BFNd isn't accepting b28
        ...
        height = self.block_heigBFN[self.tip.sha256] + 1
        coinbase = create_coinbase(height, self.coinbase_pubkey)
        b44 = CBlock()
        ...
        b44.solve()
        self.tip = b44
        self.block_heigBFN[b44.sha256] = height
        self.blocks[44] = b44
        yield accepted()
        ...
        b45.calc_sha256()
        b45.solve()
        self.block_heigBFN[b45.sha256] = self.block_heigBFN[self.tip.sha256]+1
        self.tip = b45
        self.blocks[45] = b45
        ...
        b46.solve()
        self.block_heigBFN[b46.sha256] = self.block_heigBFN[b44.sha256]+1
        self.tip = b46
        ...
        self.block_heigBFN[b71.sha256] = self.block_heigBFN[b69.sha256] + 1  # b71 builds off b69
        self.blocks[71] = b71
        ...
        #    Low-S and High-S values (whereas the BFN code has custom code which does so);
