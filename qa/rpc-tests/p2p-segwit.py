...
from test_framework.test_framework import BFNTestFramework
...
class SegWitTest(BFNTestFramework):
    ...
    def add_options(self, parser):
        parser.add_option("--oldbinary", dest="oldbinary",
                          default=None,
                          help="pre-segwit BFNd binary for upgrade testing")
    ...
    def setup_network(self):
        ...
        # If an old BFNd is given, do the upgrade-after-activation test.
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        # Right now, BFNd delays sending reject messages for blocks
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let BFNd fill it in.
    ...
    def test_block_relay(self, segwit_activated):
        ...
        if segwit_activated == False:
            ...
            all_heigBFN = list(range(chain_height+1))
            random.shuffle(all_heigBFN)
            all_heigBFN = all_heigBFN[0:10]
            for height in all_heigBFN:
    ...
    def test_p2sh_witness(self, segwit_activated):
        ...
        # segwit activation.  Note that older BFNd's that are not
    ...
    # To enable this test, pass --oldbinary=<path-to-pre-segwit-BFNd> to
    # the test.
    def test_upgrade_after_activation(self, node, node_id):
        print("\tTesting software upgrade after softfork activation")

        assert(node_id != 0) # node0 is assumed to be a segwit-active BFNd
