...
class WalletTest (BFNTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BFN from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 BFN with subtract fee from amount
        ...
        # Sendmany 10 BFN with subtract fee from amount
        ...
        #     '-zapwallettxes=1',
        #     '-zapwallettxes=2',
        #     # disabled until issue is fixed: https://github.com/BFN/BFN/issues/7463
        #     # '-salvagewallet',
        # ]
