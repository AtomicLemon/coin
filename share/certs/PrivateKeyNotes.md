...
unlocked to sign the BFN-Qt.app bundle.
...
allowing somebody to distribute a BFN-Qt.app or BFN-qt-setup.exe with a valid
...
that the BFN-qt.exe file inside the installer had not been tampered with.
