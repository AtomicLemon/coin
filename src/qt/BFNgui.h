...
#ifndef BFN_QT_BFNGUI_H
#define BFN_QT_BFNGUI_H
...
/**
  BFN GUI main class. This class represents the main window of the BFN UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BFNGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BFNGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~BFNGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a BFN wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
