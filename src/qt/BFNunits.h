...
#ifndef BFN_QT_BFNUNITS_H
#define BFN_QT_BFNUNITS_H
...
/** BFN unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BFNUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BFNUnits(QObject *parent);

    /** BFN units.
      @note Source: https://en.BFN.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BFN,
...
typedef BFNUnits::Unit BFNUnit;

#endif // BFN_QT_BFNUNITS_H
