    ...
    mapper(0)
{
    ...
    ui->BFNAtStartup->setToolTip(ui->BFNAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->BFNAtStartup->setText(ui->BFNAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BFNUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->BFNAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBFNConfButton_clicked()
{
