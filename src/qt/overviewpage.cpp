...
public:
    TxViewDelegate(const PlatformStyle *platformStyle):
        QAbstractItemDelegate(), unit(BFNUnits::BFN),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        QString amountText = BFNUnits::formatWithUnit(unit, amount, true, BFNUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& stakingBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(BFNUnits::formatWithUnit(unit, balance, false, BFNUnits::separatorAlways));
    ui->labelUnconfirmed->setText(BFNUnits::formatWithUnit(unit, unconfirmedBalance, false, BFNUnits::separatorAlways));
    ui->labelStaking->setText(BFNUnits::formatWithUnit(unit, stakingBalance, false, BFNUnits::separatorAlways));
    ui->labelImmature->setText(BFNUnits::formatWithUnit(unit, immatureBalance, false, BFNUnits::separatorAlways));
    ui->labelTotal->setText(BFNUnits::formatWithUnit(unit, balance + unconfirmedBalance + stakingBalance, false, BFNUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("BFN")
    updateDisplayUnit();
}
...
void OverviewPage::updateStakeReport(bool fImmediate=false)
{
    ...
    ui->label24hStakingStats->setText(BFNUnits::formatWithUnit(unit, aRange[i++].Total, false, BFNUnits::separatorAlways));
    ui->label7dStakingStats->setText(BFNUnits::formatWithUnit(unit, aRange[i++].Total, false, BFNUnits::separatorAlways));
    ui->label30dStakingStats->setText(BFNUnits::formatWithUnit(unit, aRange[i++].Total, false, BFNUnits::separatorAlways));
    ui->label1yStakingStats->setText(BFNUnits::formatWithUnit(unit, aRange[i++].Total, false, BFNUnits::separatorAlways));
    ui->labelallStakingStats->setText(BFNUnits::formatWithUnit(unit, aRange[i++].Total, false, BFNUnits::separatorAlways));
}
