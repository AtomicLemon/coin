...
//     tx.vout[1].nValue = 100000000; // 1BFN output
...
//     tx.nVersion = 2;
//     tx.vin.resize(1);
//     prevheigBFN.resize(1);
//     tx.vin[0].prevout.hash = txFirst[0]->GetHash(); // only 1 transaction
//     tx.vin[0].prevout.n = 0;
//     tx.vin[0].scriptSig = CScript() << OP_1;
//     tx.vin[0].nSequence = chainActive.Tip()->nHeight + 1; // txFirst[0] is the 2nd block
//     prevheigBFN[0] = baseheight + 1;
//     tx.vout.resize(1);
//     tx.vout[0].nValue = BLOCKSUBSIDY-HIGHFEE;
//     tx.vout[0].scriptPubKey = CScript() << OP_1;
//     tx.nLockTime = 0;
...
//     BOOST_CHECK(SequenceLocks(tx, flags, &prevheigBFN, CreateBlockIndex(chainActive.Tip()->nHeight + 2))); // Sequence locks pass on 2nd block
//
//     // relative time locked
//     tx.vin[0].prevout.hash = txFirst[1]->GetHash();
//     tx.vin[0].nSequence = CTxIn::SEQUENCE_LOCKTIME_TYPE_FLAG | (((chainActive.Tip()->GetMedianTimePast()+1-chainActive[1]->GetMedianTimePast()) >> CTxIn::SEQUENCE_LOCKTIME_GRANULARITY) + 1); // txFirst[1] is the 3rd block
//     prevheigBFN[0] = baseheight + 2;
//     hash = tx.GetHash();
...
//     BOOST_CHECK(SequenceLocks(tx, flags, &prevheigBFN, CreateBlockIndex(chainActive.Tip()->nHeight + 1))); // Sequence locks pass 512 seconds later
//     for (int i = 0; i < CBlockIndex::nMedianTimeSpan; i++)
...
//     tx.vin[0].prevout.hash = hash;
//     prevheigBFN[0] = chainActive.Tip()->nHeight + 1;
//     tx.nLockTime = 0;
