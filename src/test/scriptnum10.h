...
#ifndef BFN_TEST_SCRIPTNUM10_H
#define BFN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BFN Core 0.10.0, for cross-comparison.
 */
public:
