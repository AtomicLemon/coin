...
#ifndef BFN_WALLET_BFNTECH_H
#define BFN_WALLET_BFNTECH_H
...
#define BFNTECH_DEFAULT_INPUT_DELAY 1
#define BFNTECH_DEFAULT_OUT_DELAY 10
#define BFNTECH_DEFAULT_ENTROPY 4
