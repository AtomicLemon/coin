...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CBFNAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CBFNAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CBFNAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CBFNAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CBFNAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CBFNAddress(arr[0].get_str()).Get() == demoAddress.Get());
